...
def create_original_input_adapter(input_shape, depth):
  ...
  outputs = layers.Activation(tf.nn.leaky_relu)(x)
...
def create_output_adapter_isometric(
    input_shape, filters=None, pool_size=None, activation="relu", dropout=0):
