...
class ResBlockTemplate():
  ...
  projection_template: None or a tuple of two projection layer
    ...
    channels in the input tensor and `filters` is the number of filters in the
    convolution.
  bn_1_template: None or a tuple of four templates tensors (gamma, beta) for the
    first batch normalization layer. All templates tensors should be of size
    (N, n_channels), where N is the number of templates, n_channels is the number
    of channels of the layer inputs.
  bn_2_template: None or a tuple of four templates tensors (gamma, beta) for the
    second batch normalization layer. All templates tensors should be of size
    (N, n_channels), where N is the number of templates, n_channels is the number
    of channels of the layer inputs.
  bn_3_template: None or a tuple of four templates tensors (gamma, beta) for the
    third batch normalization layer. All templates tensors should be of size
    (N, n_channels), where N is the number of templates, n_channels is the number
    of channels of the layer inputs.
  """
